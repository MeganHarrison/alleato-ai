...
export default function UserMetaCard() {
  ...
  const handleSave = async () => {
    try {
      ...
      // In a real app, you would upload the avatar to storage and get a URL
      // For now, we'll use the Dicebear API with the email as seed
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="relative group">
              <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 cursor-pointer" onClick={handleAvatarClick}>
                {user?.avatarUrl ? (
                  <Image
                    width={80}
                    height={80}
                  ...
                  <div className="w-full h-full bg-brand-500 flex items-center justify-center text-white text-2xl font-semibold">
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div className="mb-7">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative group">
                    <div className="w-24 h-24 overflow-hidden border-2 border-gray-200 rounded-full dark:border-gray-700 cursor-pointer" onClick={handleAvatarClick}>
                      {avatarPreview ? (
                        <Image
                          width={96}
                          height={96}
                        ...
                        <div className="w-full h-full bg-brand-500 flex items-center justify-center text-white text-3xl font-semibold">
                          {user?.name?.charAt(0).toUpperCase() || "U"}
                        </div>
                      )}
                    </div>
                  ...
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Click on avatar to change</p>
                    <p className="text-xs text-gray-500 dark:text-gray-500">JPG, GIF or PNG. Max size of 5MB</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    <Label>X.com</Label>
                    <Input type="text" value={formData.twitter} onChange={(e) => handleInputChange('twitter', e.target.value)} />
                  </div>
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" value={formData.bio} onChange={(e) => handleInputChange('bio', e.target.value)} />
                  </div>
                </div>
              </div>
            </div>
